...
<div class="layui-container layadmin-cmdlist-fluid">
    ...
    <div class="layui-elem-quote" style="margin: 20px;padding-left: 200px;">
        <h3>所属标签：${beanData.type}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;作者： ${beanData.author}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发布时间:<fmt:formatDate value="${beanData.createtime}"
                                                               pattern="yyyy-MM-dd HH:mm:ss"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button dataid="${beanData.id}" class="layui-btn layui-btn-danger pingfen">点我评分</button>
        </h3>
    </div>
    <div id="showContent">
        <div style="text-align: center;margin-bottom: 30px;">
            <img src="${beanData.picurl}" style="width: 250px;">
        </div>
        <div style="border-radius: 80px;border: 5px solid green;text-align: center;padding: 20px;">
            <audio controls="controls" src="${beanData.outline}"></audio>
        </div>

        <div style="padding: 20px 100px;font-size: 18px;line-height:2em;">
            ${beanData.content}
        </div>
    </div>
    <style>
