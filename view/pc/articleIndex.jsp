...
<div class="layui-container layadmin-cmdlist-fluid">
    <div class="layui-row layui-col-space30 content">
        ...
        <span class="layui-breadcrumb" lay-separator="|" style="visibility: visible;">
          <a href="javascript:;" class="active">系统音乐</a><span lay-separator="">|</span>
          <a href="javascript:;">前端音乐</a><span lay-separator="">|</span>
          <a href="javascript:;">${type==null?'音乐列表':type}</a>
        </span>
            </div>
            <div class="list-item">
