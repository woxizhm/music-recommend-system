...
<blockquote class="layui-elem-quote list_search">
    <div class="layui-inline">
        <a class="layui-btn layui-btn-normal addBtn"><i class="layui-icon">&#xe608;</i> 添加问卷结果</a>
    </div>
    <div class="layui-inline">
...
<script type="text/javascript" src="${ctx}/view/manage/wenjuanjieguo/wenjuanjieguoList.js"></script>
