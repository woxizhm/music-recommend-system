...
<form id="addForm" class="my-form" method="post">
    <table class="layui-table" style="margin:20px auto;width: 80%;">
        <tr>
            ...
            <td width="35%" class="orderValue"><label>${liuyan.username}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>留言内容</label></td>
            <td width="35%" class="orderValue"><label>${liuyan.content}</label></td>
        </tr>
        <%--<tr>
            <td width="15%" align="center"><label>备注</label></td>
            <td width="35%" class="orderValue"><label>${liuyan.intro}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>图片</label></td>
            <td width="35%" class="orderValue"><label>${liuyan.picurl}</label></td>
        </tr>--%>
        <tr>
            <td width="15%" align="center"><label>创建时间</label></td>
            <td width="35%" class="orderValue"><label><fmt:formatDate value="${liuyan.createtime}"
