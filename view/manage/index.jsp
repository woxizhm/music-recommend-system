...
<head>
    <meta charset="utf-8">
    <title>基于javaweb的音乐推荐系统-后台管理系统</title>
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" id="showIndexHome">
                    <span href="#" onclick="jumpIndex()"><i
                            class="iconfont icon-computer"></i><cite>系统首页</cite></span>
                </li>
                <script>
                    //跳转到前台首页
                    function jumpIndex() {
                        var urls = "${ctx}/pc/index";
                        window.open(urls, "_blank"); //新窗口打开页面
                    }
                </script>
...
<div id="showWelcomeMsgDiv" style="display: none;">
    欢迎${sessionScope.loginuserName}登录-基于javaweb的音乐推荐系统-后台管理系统！
</div>
<!-- 移动导航 -->
