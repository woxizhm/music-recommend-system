...
<form id="addForm" class="my-form" method="post">
    <table class="layui-table" style="margin:20px auto;width: 80%;">
        <tr>
            <td width="15%" align="center"><label>标签名称</label></td>
            <td width="35%" class="orderValue"><label>${sorttype.sortname}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>标签描述</label></td>
            <td width="35%" class="orderValue"><label>${sorttype.intro}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>创建时间</label></td>
            <td width="35%" class="orderValue"><label><fmt:formatDate value="${sorttype.createtime}"
