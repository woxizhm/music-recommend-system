...
public class SorttypeController {
    ...
    public ResultUtil saveSorttype(Sorttype sorttype, HttpSession session) {
        ...
        try {
            ...
            return ResultUtil.ok("添加标签成功");
        } catch (Exception e) {
            return ResultUtil.error("添加标签出错,稍后再试！");
        }
    }
    ...
    public ResultUtil updateSorttype(Sorttype sorttype, HttpSession session) {
        ...
        try {
            ...
            return ResultUtil.ok("修改标签成功");
        } catch (Exception e) {
            return ResultUtil.error("修改标签出错,稍后再试！");
        }
    }
    ...
    public ResultUtil deleteSorttypeById(Integer id) {
        try {
            ...
            return ResultUtil.ok("删除标签成功");
        } catch (Exception e) {
            return ResultUtil.error("删除标签出错,稍后再试！");
        }
    }
